...
#### Overwrite
<Tip>
In some cases, you may want to bypass a reducer and directly overwrite a state value. LangGraph provides the `Overwrite` type for this purpose. Learn how to use `Overwrite` [here](/oss/langgraph/use-graph-api#bypass-reducers-with-overwrite).
</Tip>
:::
