...
* [Disable/enable PAT creation](https://api.smith.langchain.com/redoc#tag/orgs/operation/update_current_organization_info_api_v1_orgs_current_info_patch) (available in Helm chart version 0.11.25+)
  * use `pat_creation_disabled` to disable PAT creation for the entire organization.
  * see the [admin guide](/langsmith/administration-overview#organization-roles) for how to restrict PAT creation by user.
