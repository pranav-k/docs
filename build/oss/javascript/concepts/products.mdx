...
[LangChain](/oss/javascript/langchain/overview) is an agent framework that provides abstractions structured content blocks, the agent loop, and middleware.
...
- **Planning capabilties**: Track multiple tasks with a to-do list.
